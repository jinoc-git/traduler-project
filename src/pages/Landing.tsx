  ...
  return (
    <>
      <main className="flex flex-col justify-center">
        ...
        >
          <p className="md:hidden md:text-[36px] font-semibold sm:text-[16px]">
            가족여행, 엠티, 수련회, 우정여행, 효도여행..
          </p>
          <p className="md:hidden font-normal md:text-xlg sm:text-[12px]">
        ...
        >
          ...
          <div className="flex justify-center gap-[5px] w-[310px] h-[57px] mt-[10px] mx-auto md:hidden">
          ...
          <div className="bg-[url(https://github.com/jinoc-git/traduler-project/assets/92218638/2d3373dd-d9ba-49a2-817d-ada04da2e7e4)] bg-cover bg-no-repeat w-[500px] h-[220px] mr-[-200px] md:block sm:hidden" />
          <div className="bg-[url(https://github.com/jinoc-git/traduler-project/assets/92218638/070e09ea-78c4-4cd3-9b29-6680aeba46a4)] bg-cover bg-no-repeat w-[500px] h-[220px] mr-[-200px] md:block sm:hidden" />
          <div className="bg-[url(https://github.com/jinoc-git/traduler-project/assets/92218638/5e648670-6f6e-4737-9837-38bcac619925)] bg-cover bg-no-repeat w-[500px] h-[220px] mr-[-200px] md:block sm:hidden" />
        </section>

        <p className="text-[36px] font-semibold text-gray_dark_1 mt-[155px] text-center md:block sm:hidden">
          다녀온 후에도 모두가 오래오래 추억할 수 있게
        </p>
        ...
        >
          ...
          >
            <div>
              ...
              <button
                className="p-3 border rounded-lg border-blue w-[130px] text-blue hover:bg-blue_light_1 duration-200 md:block sm:hidden"
                onClick={() => {
                  navigate('/signin');
                }}
              >
          ...
          <button
            className="flex-center border rounded-lg border-blue w-[100px] h-[32px] text-[14px] mx-auto mt-[30px] text-blue hover:bg-blue_light_1 duration-200 md:hidden"
            onClick={() => {
              navigate('/signin');
            }}
          >
